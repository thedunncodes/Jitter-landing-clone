                        ...
                        <div className="flex flex-col xl-lg:flex-row w-[48%] xl-lg:w-[66%] gap-y-3 xl-lg:gap-x-3" >
                            <div aria-label="figma" className="w-full h-44 xl-lg:h-[100%] hover:animate-bobb" >
                                <Link href={'#figma'} style={{ animationDelay: '300ms' }} onMouseEnter={() => {setActiveCard(2)}} className={`group/figma opacity-0 flex flex-wrap items-end  w-full h-full rounded-3xl ${(activeCard === 2)? 'bg-prim' : 'bg-sec'}  animate-pop-in hover:scale-97 transition-all duration-300 ease-in-out`} >
                                    <div className="flex justify-center items-center w-full h-full xl-lg:h-auto" >
                                        <div className="w-fit flex justify-center h-fit items-center" >
