...
export default function FloatingCursor(props: FloatingCursorProps) {
    const {name, bgColor, invert} = props; 
  ...
  return (
    <div aria-label='floating-cursor-container' style={invert ? {animationDirection: 'reverse'} : {}} className='absolute z-10 left-0 w-fit animate-float' >
        ...
        <div aria-label='floating-cursor-name' className={`w-fit text-[2px] ${bg.current} h-fit flex items-end px-[1px] ml-1 font-inter text-white font-semibold`} >
